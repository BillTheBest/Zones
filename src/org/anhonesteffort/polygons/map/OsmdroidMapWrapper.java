/*
 *  This file is taken from osmdroid project
 *  https://code.google.com/p/osmdroid/
 *  LICENSE: Apache License 2.0
 *
 *  The original file is:
 *  https://code.google.com/p/osmdroid/source/browse/trunk/osmdroid-third-party/src/main/java/org/osmdroid/google/wrapper/v2/OsmdroidMapWrapper.java
 *
 *  Few fixes where applied to make it work, patches has being sent to upstream:
 *  https://code.google.com/p/osmdroid/issues/detail?id=509
 */
